[//]: # (Hello welcome to my project 
  ...
  You can find the project here: https://github.com/revoke0007/Stock-Prediction-System-Application
)
...
```bash
  git clone https://github.com/revoke0007/Stock-Prediction-System-Application.git
```
